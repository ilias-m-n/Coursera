...
def drawdown(return_series: pd.Series):
    ...
    mdd = (drawdowns.cummin())
    return pd.DataFrame({"wealth": wealth_index, 
                         "rolling_peak": previous_peaks, 
                         "dd": drawdowns,
                         "mdd": mdd})
...
def summary_stats(r, riskfree_rate=0.03):
    ...
    dd = r.aggregate(lambda r: drawdown(r).dd.min())
...
def gbm(n_years = 10, n_scenarios=1000, mu=0.07, sigma=0.15, steps_per_year=12, s_0=100.0, prices=True):
    ...
    :param prices: flag whether prices or returns returned
...
## Dynamic Liability Hedging Portfolio
...
def funding_ratio(assets, liabilities, r):
    ...
    """
    return (pv(assets, r)/pv(liabilities, r))[0]
...
## Coupon Bond Pricing, Maturity (Matching), Total Bond Returns
